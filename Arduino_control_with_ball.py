...
redLower = (70, 100, 50)  # Lower boundary of red color
redUpper = (100, 255, 255)  # Upper boundary of red color
...
while True:
    ...
    if len(cnts) > 0:
        ...
        if radius > 30:
            ...
            cv2.putText(frame, 'object', (int(x) - 50, int(y) + 50), font, 1, (255, 0, 0), 2)
    ...
    ########################################################
        ...
        if (servoOrientation == 0):
            if (servoPosition >= 90):
                servoOrientation = 1
                print(servoPosition, servoOrientation)
            else:
                servoOrientation = -1
                print(servoPosition, servoOrientation)
